// main code file - the single-particle model
...
let broadcaster_fraction = 0.0
let tetherer_fraction = 0.0
let cheater_fraction = 0.0
...
let microbes = [{type: 'b', Vmax_polymer: aly_broadcaster/Math.pow(PG_size, 2), Km_polymer: MM_polymers, Vmax_monomer: oal, Km_monomer: MM_monomers, cell_biomass: starting_biomass_value},
	            {type: 't', Vmax_polymer: aly_tetherer, Km_polymer: MM_polymers, Vmax_monomer: oal, Km_monomer: MM_monomers, cell_biomass: starting_biomass_value},
                {type: 'c', Vmax_polymer: 0, Km_polymer: 0, Vmax_monomer: oal, Km_monomer: MM_monomers, cell_biomass: starting_biomass_value}]
...
// reproduction loop
    ...
    if (!this_gp.type && randomneigh.cell_biomass > div_threshold) {          // add threshold value for replication
